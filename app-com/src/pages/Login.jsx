...
function Login() {
    const styleing={
        bg:{
            backgroundImage: "url('app-com\src\assets\download - Copy.jfif')"
        }
    }
    ...
    return (
        ...
        <div className="max-w-md mx-auto mt-10 mb-10 bg-cover bg-center">
      
            <form onSubmit={handleSubmit(loginUser)} className="bg-black shadow-md rounded px-8 py-6">
                ...
                <div className="mb-4">
                    <label className="block text-white text-sm font-bold mb-2" htmlFor="password">password <span className='text-red-400'>*</span>
                    </label>
                    <input
                        id="password"
                        name="password"
